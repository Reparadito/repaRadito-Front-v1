...
export const uploadImageAsync = async (uri) => {
  ...
  formData.append('upload_preset', 'reparaditoApp');
  formData.append('cloud_name', 'ReparaDito');

  try {
    const response = await axios.post(
      'https://api.cloudinary.com/v1_1/reparadito/upload',
      formData,
      {
        headers: {
...
//       name: "upload.jpg",
//     });
//     body.append("upload_preset", "reparaditoApp");
//     body.append("cloud_name", "ReparaDito");

//     const response = await fetch("https://api.cloudinary.com/v1_1/reparadito/upload", {
//       method: "POST",
//       body: body,
//     });
